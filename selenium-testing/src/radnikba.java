...
class radnikba {
	...
	void setUp() throws Exception {
		...
		baseUrl="https://radnikba-umeug.ondigitalocean.app/";
	}
	...
	void registerTest() throws InterruptedException {
		...
		email.sendKeys("test.tester2@gmail.com");
		Thread.sleep(2000);
	...
	void reviewTest() throws InterruptedException {
		...
		WebElement komentari = webDriver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div/div/button[2]"));
		komentari.click();
		Thread.sleep(2000);
		...
		WebElement obrisiButton = webDriver.findElement(By.xpath("/html/body/div[4]/div/div/div[2]/div/div[4]/button"));
		obrisiButton.click();
		Thread.sleep(3000);
